...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card-header text-header">รายการเสื้อผ้า</div>
            ...
            <a class="ิbtn btn-primary text-center" style="width: 98%;height:30px; margin-top: 10px" href="{{ route('admin.order-details-daily.index') }}">กลับ</a>
        </div>
    </div>
