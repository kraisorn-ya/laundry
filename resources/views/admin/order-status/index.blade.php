...
{{--                                @endif--}}
                                ...
                                <td class="row">
                                    @if($order->order_status == 1)
                                     <form method="post" action="{{ route('admin.order-status.orderStatus', $order->id) }}">
                                        @csrf
                                    ...
                                    <a class="btn btn-primary" href="{{ route('admin.order-status.pay', $order->id) }}" style="margin-left: 1%; margin-right: 1%">
                                        <i class="fas fa-eye"> ดูหลักฐานชำระเงิน</i>
                                    </a>
                                    @endif

{{--                                    @if($order->pay_status == 1)--}}
{{--                                    <form method="post" action="{{ route('admin.order-status.sendStatus', $order->id) }}">--}}
{{--                                        @csrf--}}
{{--                                        <button type="submit" class="btn btn-success">--}}
{{--                                            จัดส่ง--}}
{{--                                        </button>--}}
{{--                                    </form>--}}
{{--                                    @endif--}}
                                    <a class="btn btn-outline-info" href="{{ route('admin.order-status.detail', $order->id) }}">
                                        ดูรายละเอียด
                                    </a>
                                </td>
