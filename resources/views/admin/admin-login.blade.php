    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form-title" style="background-image: url({{ asset('img/bg-admin2.png') }}); height: 300px">
                    <span class="login100-form-title-1" style="margin-top: 31%">Login Admin</span>
                </div>
